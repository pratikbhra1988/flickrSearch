package com.flicker.flickersearch.utils.custom
...
class RoundedCornerImage : ImageView {
        ...
        if (attrs != null) {
            ...
            if (typedArray != null && typedArray.length() > 0) {
                try {
                    ...
                    this.radius = typedArray.getDimension(R.styleable.RoundedCornerImage_corner, 8.0f)
                } finally {
                    typedArray.recycle()
                }
            }
